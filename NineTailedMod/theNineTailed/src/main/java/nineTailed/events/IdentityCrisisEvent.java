...
import static nineTailed.NarutoMod.makeEventPath;

public class IdentityCrisisEvent extends AbstractImageEvent {
    
    public static final String ID = NarutoMod.makeID("IdentityCrisisEvent");
            ...
            case 0:
                switch (i) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        imageEventText.loadImage("theTricksterResources/images/events/IdentityCrisisEvent2.png");
