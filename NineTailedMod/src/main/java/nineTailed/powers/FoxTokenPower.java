...
public class FoxTokenPower extends AbstractPower {
    public AbstractCreature source;

    public static final String POWER_ID = NarutoMod.makeID("FoxTokenPower");
    ...
    public FoxTokenPower(final AbstractCreature owner, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public void stackPower(int stackAmount) {
        ...
        if (this.amount >= COUNT) {// 41
            this.addToTop(new ChangeStanceAction(WrathStance.STANCE_ID));// 42
