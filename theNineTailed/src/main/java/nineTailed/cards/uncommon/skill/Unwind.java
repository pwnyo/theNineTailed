...
public class Unwind extends AbstractDynamicCard {
    public final static String ID = makeID(Unwind.class.getSimpleName());
    public static final String IMG = makeCardPath("Unwind.png");
