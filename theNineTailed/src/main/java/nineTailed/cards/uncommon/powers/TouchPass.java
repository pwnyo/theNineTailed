...
import nineTailed.powers.TouchPassPower;
...
public class TouchPass extends AbstractDynamicCard {
    ...
    public static final String IMG = makeCardPath("TouchPass.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new TouchPassPower(p, p, magicNumber)));
    }
