...
public class OutnumberPower extends AbstractPower {
    public AbstractCreature source;

    public static final String POWER_ID = NarutoMod.makeID("OutnumberPower");
    ...
    public OutnumberPower(final AbstractCreature owner, final int amount) {
        name = NAME;
        ID = POWER_ID;
