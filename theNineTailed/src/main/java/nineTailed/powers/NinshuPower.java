...
public class NinshuPower extends AbstractPower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("ninshu84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("ninshu32.png"));
    private int hpLoss;
