...
public class SpiralScroll extends CustomRelic {
    ...
    private static final Texture IMG = TextureLoader.getTexture(makeRelicPath("spiral_scroll.png"));
    private static final Texture OUTLINE = TextureLoader.getTexture(makeRelicOutlinePath("spiral_scroll.png"));
